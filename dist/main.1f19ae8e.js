...
},{"./bundle-url":"../../../../../.config/yarn/global/node_modules/parcel/src/builtins/bundle-url.js"}],"default.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../../.config/yarn/global/node_modules/parcel/src/builtins/css-loader.js"}],"formoat.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
(0, _jquery.default)('.computed').html(computedHtml);
var currentNumber = localStorage.getItem('currentNumber') * 1 || (0, _jquery.default)('.showNumber >span').text() * 1;
(0, _jquery.default)('.showNumber  >span').text(currentNumber);
(0, _jquery.default)('.add').bind('click', function () {
  var countEnd = currentNumber += 10;
  (0, _jquery.default)('.showNumber >span').text(countEnd);
  localStorage.setItem('currentNumber', countEnd.toString());
});
(0, _jquery.default)('.sub').bind('click', function () {
  var countEnd = currentNumber -= 10;
  (0, _jquery.default)('.showNumber >span').text(countEnd);
  localStorage.setItem('currentNumber', countEnd.toString());
});
(0, _jquery.default)('.multiply').bind('click', function () {
  var countEnd = currentNumber *= 2;
  (0, _jquery.default)('.showNumber >span').text(countEnd);
  localStorage.setItem('currentNumber', countEnd.toString());
});
(0, _jquery.default)('.divide').bind('click', function () {
  var countEnd = currentNumber /= 2;
  (0, _jquery.default)('.showNumber >span').text(countEnd);
  localStorage.setItem('currentNumber', countEnd.toString());
});
...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../../.config/yarn/global/node_modules/parcel/src/builtins/css-loader.js"}],"move.js":[function(require,module,exports) {
"use strict";
...
(0, _jquery.default)('.moveDiv').bind('click', function () {
  if ((0, _jquery.default)('.moveDiv').hasClass('moving')) {
    (0, _jquery.default)('.moveDiv').removeClass('moving');
  } else {
    (0, _jquery.default)('.moveDiv').addClass('moving');
  }
});
},{"jquery":"../node_modules/jquery/dist/jquery.js","./move.css":"move.css"}],"round.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../../.config/yarn/global/node_modules/parcel/src/builtins/css-loader.js"}],"round.js":[function(require,module,exports) {
"use strict";
...
(0, _jquery.default)('.roundDiv').bind('mouseenter', function () {
  (0, _jquery.default)('.roundDiv').addClass('colorful');
}).bind('mouseleave', function () {
  (0, _jquery.default)('.roundDiv').removeClass('colorful');
});
},{"jquery":"../node_modules/jquery/dist/jquery.js","./round.css":"round.css"}],"main.js":[function(require,module,exports) {
"use strict";
